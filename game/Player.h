...
extern const idEventDef EV_ShowBuymenu;
extern const idEventDef EV_HideBuymenu;
...
public:
	...
	void					UpdateCollectableGUI(void);
...
public:
	...
	idUserInterface* buyMenuGui; // buymenu

	riBuyingManager	buyingManager;
...
public:
	...
	void					PlusOneCollectables();
	int						GetCollectables(void) const;
...
private:
	...
	void					Event_BuyWeapon(const char* weaponName);
