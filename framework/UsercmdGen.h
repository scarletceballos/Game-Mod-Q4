...
const int IMPULSE_23			= 23;			// wave starter
const int IMPULSE_24			= 24;			// cheat for collectables
...
const int IMPULSE_103			= 103;			// Buy weapon_floorlauncher
...
const int IMPULSE_108			= 108;			// Buy weapon_wallLauncher
